...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.region, region) || other.region == region)&&(identical(other.qualification, qualification) || other.qualification == qualification)&&(identical(other.level, level) || other.level == level)&&(identical(other.levelTitle, levelTitle) || other.levelTitle == levelTitle)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.totalHours, totalHours) || other.totalHours == totalHours)&&(identical(other.totalTasks, totalTasks) || other.totalTasks == totalTasks)&&(identical(other.placesVisited, placesVisited) || other.placesVisited == placesVisited)&&(identical(other.totalPoints, totalPoints) || other.totalPoints == totalPoints)&&(identical(other.joinedAt, joinedAt) || other.joinedAt == joinedAt)&&(identical(other.idFileUrl, idFileUrl) || other.idFileUrl == idFileUrl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,phone,avatarUrl,region,qualification,level,levelTitle,rating,totalHours,totalTasks,placesVisited,totalPoints,joinedAt,idFileUrl);

@override
String toString() {
  return 'ProfileModel(id: $id, name: $name, email: $email, phone: $phone, avatarUrl: $avatarUrl, region: $region, qualification: $qualification, level: $level, levelTitle: $levelTitle, rating: $rating, totalHours: $totalHours, totalTasks: $totalTasks, placesVisited: $placesVisited, totalPoints: $totalPoints, joinedAt: $joinedAt, idFileUrl: $idFileUrl)';
}
...
/// Create a copy of ProfileModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? email = null,Object? phone = null,Object? avatarUrl = null,Object? region = null,Object? qualification = null,Object? level = null,Object? levelTitle = null,Object? rating = null,Object? totalHours = null,Object? totalTasks = null,Object? placesVisited = null,Object? totalPoints = null,Object? joinedAt = null,Object? idFileUrl = freezed,}) {
...
as String,idFileUrl: freezed == idFileUrl ? _self.idFileUrl : idFileUrl // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String phone, @JsonKey(name: 'avatar_url')  String avatarUrl,  String region,  String qualification,  int level, @JsonKey(name: 'level_title')  String levelTitle,  double rating, @JsonKey(name: 'total_hours')  int totalHours, @JsonKey(name: 'total_tasks')  int totalTasks, @JsonKey(name: 'places_visited')  int placesVisited, @JsonKey(name: 'total_points')  int totalPoints, @JsonKey(name: 'joined_at')  String joinedAt, @JsonKey(name: 'id_file_url')  String? idFileUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phone,_that.avatarUrl,_that.region,_that.qualification,_that.level,_that.levelTitle,_that.rating,_that.totalHours,_that.totalTasks,_that.placesVisited,_that.totalPoints,_that.joinedAt,_that.idFileUrl);case _:
  return orElse();
...
@override@JsonKey(name: 'id_file_url') final  String? idFileUrl;
