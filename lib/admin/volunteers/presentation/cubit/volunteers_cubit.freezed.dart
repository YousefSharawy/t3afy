...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VolunteersState);
}
...
/// @nodoc
class $VolunteersStateCopyWith<$Res>  {
$VolunteersStateCopyWith(VolunteersState _, $Res Function(VolunteersState) __);
}


/// Adds pattern-matching-related methods to [VolunteersState].
extension VolunteersStatePatterns on VolunteersState {
...
class _Initial implements VolunteersState {
  const _Initial();
...
@override
String toString() {
  return 'VolunteersState.initial()';
}
...
class _Loading implements VolunteersState {
  const _Loading();
...
@override
String toString() {
  return 'VolunteersState.loading()';
}
...
class _Loaded implements VolunteersState {
 ...
 List<AdminVolunteerEntity> get volunteers {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $VolunteersStateCopyWith<$Res> {
...
class _Error implements VolunteersState {
...
@override
String toString() {
  return 'VolunteersState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $VolunteersStateCopyWith<$Res> {
