...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,phone,avatarUrl,region,qualification,level,levelTitle,rating,totalHours,totalTasks,placesVisited,joinedAt);

@override
String toString() {
  return 'ProfileModel(id: $id, name: $name, email: $email, phone: $phone, avatarUrl: $avatarUrl, region: $region, qualification: $qualification, level: $level, levelTitle: $levelTitle, rating: $rating, totalHours: $totalHours, totalTasks: $totalTasks, placesVisited: $placesVisited, joinedAt: $joinedAt)';
}
...
@useResult
$Res call({
 String id, String name, String email, String phone,@JsonKey(name: 'avatar_url') String avatarUrl, String region, String qualification, int level,@JsonKey(name: 'level_title') String levelTitle, double rating,@JsonKey(name: 'total_hours') int totalHours,@JsonKey(name: 'total_tasks') int totalTasks,@JsonKey(name: 'places_visited') int placesVisited,@JsonKey(name: 'joined_at') String joinedAt
});
...
/// Create a copy of ProfileModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? email = null,Object? phone = null,Object? avatarUrl = null,Object? region = null,Object? qualification = null,Object? level = null,Object? levelTitle = null,Object? rating = null,Object? totalHours = null,Object? totalTasks = null,Object? placesVisited = null,Object? joinedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String phone, @JsonKey(name: 'avatar_url')  String avatarUrl,  String region,  String qualification,  int level, @JsonKey(name: 'level_title')  String levelTitle,  double rating, @JsonKey(name: 'total_hours')  int totalHours, @JsonKey(name: 'total_tasks')  int totalTasks, @JsonKey(name: 'places_visited')  int placesVisited, @JsonKey(name: 'joined_at')  String joinedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phone,_that.avatarUrl,_that.region,_that.qualification,_that.level,_that.levelTitle,_that.rating,_that.totalHours,_that.totalTasks,_that.placesVisited,_that.joinedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String phone, @JsonKey(name: 'avatar_url')  String avatarUrl,  String region,  String qualification,  int level, @JsonKey(name: 'level_title')  String levelTitle,  double rating, @JsonKey(name: 'total_hours')  int totalHours, @JsonKey(name: 'total_tasks')  int totalTasks, @JsonKey(name: 'places_visited')  int placesVisited, @JsonKey(name: 'joined_at')  String joinedAt)  $default,) {final _that = this;
switch (_that) {
case _ProfileModel():
return $default(_that.id,_that.name,_that.email,_that.phone,_that.avatarUrl,_that.region,_that.qualification,_that.level,_that.levelTitle,_that.rating,_that.totalHours,_that.totalTasks,_that.placesVisited,_that.joinedAt);case _:
  throw StateError('Unexpected subclass');
...
class _ProfileModel implements ProfileModel {
  const _ProfileModel({required this.id, required this.name, required this.email, this.phone = '', @JsonKey(name: 'avatar_url') this.avatarUrl = '', this.region = '', this.qualification = '', this.level = 1, @JsonKey(name: 'level_title') this.levelTitle = 'متطوع جديد', this.rating = 0.0, @JsonKey(name: 'total_hours') this.totalHours = 0, @JsonKey(name: 'total_tasks') this.totalTasks = 0, @JsonKey(name: 'places_visited') this.placesVisited = 0, @JsonKey(name: 'joined_at') this.joinedAt = ''});
